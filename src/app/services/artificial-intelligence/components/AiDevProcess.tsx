    ...
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-col-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={index}
            className={`w-full font-[cabin] border bg-[#3D3D3D] p-8 flex flex-col justify-between items-start rounded-xl`}
          >
            <Image
              width={400}
              height={400}
            ...
            <p className="font-[cabin] tracking-widest text-gray-50   text-sm/5 w-full mx-auto text-left mb-8">
              {service?.description}
            </p>
          </div>
        ))}
