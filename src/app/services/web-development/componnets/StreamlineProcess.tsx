    ...
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4 bg-[#242424]">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div
            key={index}
            className={`w-full lg:min-h-[40vh]  2xl:min-h-auto font-[cabin] rounded-xl bg-[#3D3D3D] p-8 flex flex-col justify-center gap-y-2 items-center ${
          ...
          >
            ...
            <h2 className="text-gray-50 text-base w-full mx-auto text-center">
              {service?.title}
            </h2>
            <p className="font-[cabin] tracking-widest text-gray-50 text-sm/5 w-full mx-auto text-center mb-12">
              {service?.description}
            </p>
          </div>
        ))}
