    ...
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-col-2 lg:grid-cols-2 gap-4">
        {[
          ...
          <div
            key={index}
            className={`w-full lg:min-h-[55vh] 2xl:min-h-auto font-[cabin] rounded-none border border-[#EE3639] p-8 flex flex-col justify-around items-start `}
          >
            <p className="w-14 h-14 font-semibold text-2xl p-2 mb-0 relative">
              {"0"}
              {index + 1}{" "}
            </p>
            ...
            <p className="font-[cabin] tracking-widest text-gray-800  font-light text-sm/5 w-full mx-auto text-left mb-4">
              {service?.description}
            </p>
          </div>
        ))}
