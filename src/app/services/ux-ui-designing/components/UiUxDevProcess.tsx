    ...
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-col-2 lg:grid-cols-4">
        {[
          ...
          <div
            key={index}
            className={`w-full font-[cabin]  px-6 flex flex-col justify-center items-center relative`}
          >
            <Image
              width={400}
              height={400}
            ...
            />
            <h2
              className={`text-gray-900 font-semibold text-2xl font-[Urbanist] w-full mx-auto text-center mb-2`}
            >
              {service?.title}
            </h2>
          </div>
