  ...
  return (
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4 font-[cabin] tracking-widest">
      <div className=" m-auto p-18  rounded-3xl text-center">
        ...
        <p
          className={`lg:w-3/5 text-gray-800 text-sm sm:text-lg md:text-xl lg:text-[16px] xl:text-[14px] line-clamp-3 md:line-clamp-none font-[cabin] tracking-widest  mt-4 mb-6 m-auto leading-5`}
        >
          {
