  ...
  return (
    <div className="container max-w-7xl mx-auto p-4 lg:p-16 space-y-4 font-[poppins] tracking-widest">
      <div className=" m-auto p-18  rounded-3xl text-center">
        ...
        <p
          className={`lg:w-4/5 text-gray-800 text-sm sm:text-lg md:text-xl lg:text-lg py-5 line-clamp-3 md:line-clamp-none font-[poppins] tracking-widest  mt-4 mb-6 m-auto`}
        >
          {
