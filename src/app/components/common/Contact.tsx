...
import HomeGetStartedForm from "../home/HomeContactUs";
...
const Contact = () => {
  ...
  // }
  return <div className="pb-10"><HomeGetStartedForm /></div>
};
...
//     <div>
//       <div className="rounded-r-2xl text-black">
...
//             />
//             {errors.firstName && (
//               <p className="font-[poppins] tracking-widest text-red-500 text-sm">
//                 {errors.firsName}
//               </p>
//             )}
//           </div>
